...
export const TRANSLATIONS: Dict = {
  ...
  "branch.promos.title": { en: "Promos", ru: "Акции", am: "Ակցիաներ" },
  "branch.promos.subtitle": {
    en: "Time-windowed discounts on the per-hour rate. The discount applies on selected weekdays inside the window.",
    ru: "Скидки на почасовую ставку в выбранные дни недели и часы.",
    am: "Զեղչեր ժամային սակագնի վրա ընտրված շաբաթվա օրերին և ժամերին։",
  },
  "branch.promos.new": { en: "+ New promo", ru: "+ Новая акция", am: "+ Նոր ակցիա" },
  "branch.promos.empty": {
    en: "No promos yet. Add one to surface a time-limited discount on the player app.",
    ru: "Акций пока нет. Добавьте, чтобы показать скидку в мобильном приложении.",
    am: "Ակցիաներ դեռ չկան։ Ավելացրեք՝ մոբայլում զեղչը ցուցադրելու համար։",
  },
  "branch.promos.titleNew": { en: "New promo", ru: "Новая акция", am: "Նոր ակցիա" },
  "branch.promos.titleEdit": { en: "Edit promo", ru: "Редактировать акцию", am: "Խմբագրել ակցիան" },
  "branch.promos.platform": { en: "Platform", ru: "Платформа", am: "Պլատֆորմա" },
  "branch.promos.tier": { en: "Tier", ru: "Тариф", am: "Սակագին" },
  "branch.promos.discountedPrice": { en: "Discounted price / hour", ru: "Цена акции за час", am: "Ակցիայի գին / ժամ" },
  "branch.promos.startTime": { en: "Start time", ru: "Время начала", am: "Սկսի ժամ" },
  "branch.promos.endTime": { en: "End time", ru: "Время окончания", am: "Ավարտի ժամ" },
  "branch.promos.days": { en: "Weekdays", ru: "Дни недели", am: "Շաբաթվա օրեր" },
  "branch.promos.activeNow": { en: "Active now", ru: "Сейчас активна", am: "Հիմա ակտիվ է" },
  "branch.promos.confirmDelete": { en: "Delete promo", ru: "Удалить акцию", am: "Ջնջել ակցիան" },
  "branch.promos.errors.days": {
    en: "Select at least one weekday",
    ru: "Выберите хотя бы один день недели",
    am: "Ընտրեք առնվազն մեկ օր",
  },
  "branch.promos.errors.price": {
    en: "Discounted price must be 0 or more",
    ru: "Цена акции должна быть 0 или больше",
    am: "Ակցիայի գինը պետք է լինի 0 կամ ավելի",
  },
  "branch.promos.errors.time": {
