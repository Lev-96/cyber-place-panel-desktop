...
export const TRANSLATIONS: Dict = {
  ...
  "support.startForBranch": { en: "Open a request for", ru: "Создать обращение для", am: "Բացել դիմում" },
  "support.pickBranch": { en: "Choose a branch…", ru: "Выберите филиал…", am: "Ընտրեք մասնաճյուղը…" },
