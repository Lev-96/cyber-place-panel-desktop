...
export class MemberRepository {
  ...
  create(b: CreateMemberBody) { return withToast("member", "created", () => friendlyMutation(apiCreateMember(b).then((r) => r.member))); }
  update(id: number, b: UpdateMemberBody) { return withToast("member", "updated", () => friendlyMutation(apiUpdateMember(id, b).then((r) => r.member))); }
  remove(id: number) { return withToast("member", "deleted", () => friendlyMutation(apiDeleteMember(id).then(() => undefined))); }
