  ...
  <Suspense fallback={<Spinner />}>
    <Routes>
      <Route element={<Layout />}>
        ...
        <Route path="/branches" element={<RoleGuard perm="menu.branches"><BranchesList /></RoleGuard>} />
        <Route path="/branches-map" element={<RoleGuard perm="menu.map"><BranchesMap /></RoleGuard>} />
        <Route path="/branches/:branchId" element={<BranchHub />} />
        <Route path="/branches/:branchId/edit" element={<RoleGuard perm="branch.edit"><BranchEdit /></RoleGuard>} />
        <Route path="/branches/:branchId/live" element={<BranchLive />} />
        <Route path="/branches/:branchId/places" element={<BranchPlaces />} />
        <Route path="/branches/:branchId/services" element={<BranchServices />} />
        <Route path="/branches/:branchId/tournaments" element={<Tournaments />} />
        ...
        <Route path="/branches/:branchId/managers" element={<RoleGuard perm="manager.create"><Managers /></RoleGuard>} />

        {/* Bookings — everyone */}
        <Route path="/bookings" element={<Bookings />} />
        <Route path="/bookings/confirm" element={<RoleGuard perm="menu.scan"><ConfirmByCode /></RoleGuard>} />
        <Route path="/bookings/:bookingId" element={<BookingDetails />} />

        {/* Tournaments — visible to all roles that have menu.tournaments */}
        <Route path="/tournaments" element={<RoleGuard perm="menu.tournaments"><Tournaments /></RoleGuard>} />
        <Route path="/tournaments/:tournamentId" element={<RoleGuard perm="menu.tournaments"><TournamentDetails /></RoleGuard>} />
        ...
        <Route path="/managers" element={<RoleGuard perm="menu.managers"><Managers /></RoleGuard>} />
        <Route path="/games" element={<RoleGuard perm="menu.games"><GamesList /></RoleGuard>} />
        <Route path="/services-admin" element={<RoleGuard perm="menu.servicesAdmin"><ServicesAdmin /></RoleGuard>} />
        <Route path="/companies" element={<RoleGuard perm="menu.companies"><CompaniesList /></RoleGuard>} />
        <Route path="/companies/:companyId" element={<CompanyDetails />} />
        <Route path="/companies/:companyId/branches" element={<CompanyBranches />} />
        <Route path="/companies/:companyId/revenue" element={<RoleGuard perm="menu.companies"><CompanyRevenue /></RoleGuard>} />
        <Route path="/revenue" element={<RoleGuard perm="menu.companies"><Revenue /></RoleGuard>} />
        <Route path="/my-company" element={<RoleGuard perm="menu.myCompany"><MyCompany /></RoleGuard>} />
